...
本机使用
```
python train.py --dataset coco --coco_path /data/codes/zsh/Voc07_MSCOCO/coco --depth 50
```
...
Note that the --csv_val argument is optionapython train.py --dataset coco --coco_path /data/codes/zsh/Voc07_MSCOCO/coco --depth 50
l, in which case no validation will be performed.
