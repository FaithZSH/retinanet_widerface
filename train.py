...
from retinanet.dataloader import CocoDataset, CSVDataset, collater, NoResizer, Resizer, AspectRatioBasedSampler, \
...
def main(args=None):
    ...
    if parser.pretrained:
        retinanet = torch.load(parser.pretrained)
            ...
            try:
                ...
                if iter_num % 10 == 1:
                    print(
                        ...
                        'loss: {:1.5f}'.format(epoch_num, iter_num, float(classification_loss),
